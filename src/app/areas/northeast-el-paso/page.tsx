...
export const metadata: Metadata = {
  title: "Northeast El Paso | Sandstone Real Estate Group",
};

export default function NortheastElPasoPage() {
  return (
    <>
      <SiteHeader variant="lead" showDesktopCenterLogo={false} />
      <main className="flex min-h-screen items-center justify-center bg-[var(--sandstone-off-white)]">
        <div className="text-center">
          <p className="text-xs font-bold uppercase tracking-[0.12em] text-[var(--sandstone-sand-gold)]">Northeast El Paso, TX</p>
