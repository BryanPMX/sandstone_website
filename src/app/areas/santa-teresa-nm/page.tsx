...
export const metadata: Metadata = {
  title: "Santa Teresa NM | Sandstone Real Estate Group",
};
    ...
    <>
      ...
      <main className="flex min-h-screen items-center justify-center bg-[var(--sandstone-off-white)]">
        <div className="text-center">
          <p className="text-xs font-bold uppercase tracking-[0.12em] text-[var(--sandstone-sand-gold)]">Santa Teresa, NM</p>
