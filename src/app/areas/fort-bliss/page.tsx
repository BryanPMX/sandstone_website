...
export const metadata: Metadata = {
  title: "Fort Bliss | Sandstone Real Estate Group",
};

export default function FortBlissPage() {
  return (
    <>
      <SiteHeader variant="lead" showDesktopCenterLogo={false} />
      <main className="flex min-h-screen items-center justify-center bg-[var(--sandstone-off-white)]">
        <div className="text-center">
          <p className="text-xs font-bold uppercase tracking-[0.12em] text-[var(--sandstone-sand-gold)]">Fort Bliss, TX</p>
