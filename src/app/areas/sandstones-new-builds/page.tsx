...
const MODELS: HomeModel[] = [
  ...
  photos: [
      ...
      { src: `${BASE}/model/interior/Maribel Interior 1.webp`, alt: "Maribel Kitchen" },
      { src: `${BASE}/model/interior/Maribel Interior 2.webp`, alt: "Maribel Living Room" },
      { src: `${BASE}/model/interior/Render Interior 3.webp`, alt: "Maribel Master Bedroom" },
      { src: `${BASE}/model/interior/Render Interior 4.webp`, alt: "Maribel Master Bedroom" },
      { src: `${BASE}/model/interior/Render Interior 5.webp`, alt: "Maribel Master Bedroom" },
      { src: `${BASE}/model/interior/Render Interior 6.webp`, alt: "Maribel Master Bedroom" },
      { src: `${BASE}/model/interior/Render Interior 7.webp`, alt: "Maribel Master Bedroom" },
      { src: `${BASE}/model/interior/Render Interior 8.webp`, alt: "Maribel Master Bedroom" },
      { src: `${BASE}/model/interior/Render Interior 9.webp`, alt: "Maribel Master Bedroom" },
      { src: `${BASE}/model/interior/Render Interior 10.webp`, alt: "Maribel Master Bedroom" },
      { src: `${BASE}/model/interior/Render Interior 11.webp`, alt: "Maribel Master Bathroom" },
      { src: `${BASE}/model/interior/Render Interior 12.webp`, alt: "Maribel Master Bathroom pt.2" },
      { src: `${BASE}/model/interior/Render Interior 13.webp`, alt: "Maribel Master Bathroom pt.3" },
      { src: `${BASE}/model/interior/Render Interior 14.webp`, alt: "Maribel Master Bathroom pt.4" },
      { src: `${BASE}/model/interior/Render Interior 15.webp`, alt: "Maribel Master Bathroom pt.5" },
      { src: `${BASE}/model/interior/Render Interior 16.webp`, alt: "Maribel Master Bathroom pt.6" },
      { src: `${BASE}/model/interior/Render Interior 17.webp`, alt: "Maribel Master Bathroom pt.7" },
      { src: `${BASE}/model/interior/Render Interior 18.webp`, alt: "Maribel Master Bathroom pt.8" }, 
      { src: `${BASE}/model/interior/Render Interior 19.webp`, alt: "Maribel Master Bathroom pt.9" },
      { src: `${BASE}/model/interior/Render Interior 20.webp`, alt: "Maribel Master Bathroom pt.10" },
      { src: `${BASE}/model/interior/Render Interior 21.webp`, alt: "Maribel Master Bathroom pt.11" },
    ],
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[var(--sandstone-off-white)]">
        ...
        <ExploreNearbyAreas compact currentAreaHref="/areas/sandstones-new-builds" />
