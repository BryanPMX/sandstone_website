...
const MODELS: HomeModel[] = [
  {
    ...
    price:       "$XXX,XXX",
    photos: [
      { src: `${BASE}/model/maribel-exterior.jpg`, alt: "Maribel — Exterior Front"   },
      { src: `${BASE}/model/maribel-exterior.jpg`, alt: "Maribel — Living Room"      },
      { src: `${BASE}/model/maribel-exterior.jpg`, alt: "Maribel — Kitchen"          },
      { src: `${BASE}/model/maribel-exterior.jpg`, alt: "Maribel — Master Suite"     },
      { src: `${BASE}/model/maribel-exterior.jpg`, alt: "Maribel — Master Bath"      },
      { src: `${BASE}/model/maribel-exterior.jpg`, alt: "Maribel — Guest Room"       },
      { src: `${BASE}/model/maribel-exterior.jpg`, alt: "Maribel — Study"            },
      { src: `${BASE}/model/maribel-exterior.jpg`, alt: "Maribel — Outdoor Living"   },
    ],
  ...
  },
  {
    ...
    price:       "$XXX,XXX",
    photos: [
      { src: `${BASE}/model/maribel-exterior.jpg`, alt: "Clarissa — Exterior Front"  },
      { src: `${BASE}/model/maribel-exterior.jpg`, alt: "Clarissa — Living Room"     },
      { src: `${BASE}/model/maribel-exterior.jpg`, alt: "Clarissa — Kitchen"         },
      { src: `${BASE}/model/maribel-exterior.jpg`, alt: "Clarissa — Master Suite"    },
      { src: `${BASE}/model/maribel-exterior.jpg`, alt: "Clarissa — Master Bath"     },
      { src: `${BASE}/model/maribel-exterior.jpg`, alt: "Clarissa — Guest Room"      },
      { src: `${BASE}/model/maribel-exterior.jpg`, alt: "Clarissa — Study"           },
      { src: `${BASE}/model/maribel-exterior.jpg`, alt: "Clarissa — Outdoor Living"  },
    ],
