...
const HC_CENTER: [number, number] = [31.692, -106.207];
const HC_ZOOM = 12;
const PAGE_SIZE = 6;
...
export function HorizonListings() {
  ...
  useEffect(() => {
    fetch("/api/listings/horizon-city")
      .then((r) => r.json())
  ...
  return (
    <div className="mt-6">
      ...
      <div className="mt-5 grid grid-cols-1 gap-5 lg:grid-cols-[minmax(0,1.15fr)_minmax(320px,1fr)]">
        <ListingsMapPanel
          properties={filtered}
          initialCenter={HC_CENTER}
          initialZoom={HC_ZOOM}
          mapContextQuery={{ from: "horizon-city" }}
        />
