...
const CANUTILLO_CENTER: [number, number] = [31.911, -106.6];
const CANUTILLO_ZOOM = 12;
const PAGE_SIZE = 6;
...
export function CanutilloListings() {
  ...
  useEffect(() => {
    ...
    fetch("/api/listings/canutillo-tx")
      .then((r) => r.json())
  ...
  return (
    <div className="mt-6">
      ...
      <div className="mt-5 grid grid-cols-1 gap-5 lg:grid-cols-[minmax(0,1.15fr)_minmax(320px,1fr)]">
        <ListingsMapPanel
          properties={filtered}
          initialCenter={CANUTILLO_CENTER}
          initialZoom={CANUTILLO_ZOOM}
          mapContextQuery={{ from: "canutillo-tx" }}
        />
