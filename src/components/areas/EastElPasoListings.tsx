...
const EAST_CENTER: [number, number] = [31.758, -106.285];
const EAST_ZOOM = 12;
const PAGE_SIZE = 6;
...
export function EastElPasoListings() {
  ...
  useEffect(() => {
    fetch("/api/listings/east-el-paso")
      .then(r => r.json())
  ...
  return (
    <div className="mt-6">
      ...
      <div className="mt-5 grid grid-cols-1 gap-5 lg:grid-cols-[minmax(0,1.15fr)_minmax(320px,1fr)]">
        ...
        <ListingsMapPanel
          properties={filtered}
          initialCenter={EAST_CENTER}
          initialZoom={EAST_ZOOM}
          mapContextQuery={{ from: "east-el-paso" }}
        />
