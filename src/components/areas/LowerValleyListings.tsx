...
const LV_CENTER: [number, number] = [31.74, -106.39];
const LV_ZOOM = 12;
const PAGE_SIZE = 6;
...
export function LowerValleyListings() {
  ...
  useEffect(() => {
    fetch("/api/listings/lower-valley")
      .then(r => r.json())
  ...
  return (
    <div className="mt-6">
      ...
      <div className="mt-5 grid grid-cols-1 gap-5 lg:grid-cols-[minmax(0,1.15fr)_minmax(320px,1fr)]">
        ...
        <ListingsMapPanel
          properties={filtered}
          initialCenter={LV_CENTER}
          initialZoom={LV_ZOOM}
          mapContextQuery={{ from: "lower-valley" }}
        />
