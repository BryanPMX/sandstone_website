...
const DT_CENTER: [number, number] = [31.761, -106.491];
const DT_ZOOM = 13;
const PAGE_SIZE = 6;
...
export function DowntownUtepListings() {
  ...
  useEffect(() => {
    fetch("/api/listings/downtown-utep")
      .then(r => r.json())
  ...
  return (
    <div className="mt-6">
      ...
      <div className="mt-5 grid grid-cols-1 gap-5 lg:grid-cols-[minmax(0,1.15fr)_minmax(320px,1fr)]">
        ...
        <ListingsMapPanel
          properties={filtered}
          initialCenter={DT_CENTER}
          initialZoom={DT_ZOOM}
          mapContextQuery={{ from: "downtown-utep" }}
        />
