...
export function LegalDocumentLayout({
  ...
  lastUpdated,
  children,
  label = "Public legal page",
}: LegalDocumentLayoutProps) {
  return (
    <main>
      <section
        aria-labelledby="legal-document-title"
        className="mx-auto max-w-4xl px-4 pb-14 pt-24 md:pb-16 md:pt-28"
      >
        <div className="overflow-hidden rounded-2xl border border-[var(--sandstone-navy)]/10 bg-white shadow-lg">
          <header className="border-b border-[var(--sandstone-navy)]/10 bg-[var(--sandstone-off-white)] px-6 py-6 sm:px-8">
            ...
            <h1
              ...
              className="mt-4 font-heading text-3xl font-bold text-[var(--sandstone-navy)] md:text-4xl"
            >
              {title}
            </h1>
